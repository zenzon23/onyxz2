...
title.Text = "ONYX HUB paste get key to your tab"
...
do
    local Window = Fluent:CreateWindow({
        Title = string.format("%s <b><i>🔥ONYX HUB🔥</i></b>", string.format(MonthlyLabels[os.date("*t").month], "Freemium")),
        SubTitle = "By zenzon",
    ...
    Tabs.Aimbot:AddParagraph({
        Title = string.format("%s 🔥ONYX HUB🔥", string.format(MonthlyLabels[os.date("*t").month], "Joln our dc for free exec")),
        Content = "✨BEST free script✨https://discord.gg/bnhQKTar5u"
    })
    ...
    Tabs.Bots:AddParagraph({
        Title = string.format("%s 🔥Freemium🔥", string.format(MonthlyLabels[os.date("*t").month], "JOLN OUR DC")),
        Content = "✨BEST free script✨https://discord.gg/bnhQKTar5u"
    })
    ...
    Tabs.Checks:AddParagraph({
        Title = string.format("%s 🔥Freemiun🔥", string.format(MonthlyLabels[os.date("*t").month], "joln our dc")),
        Content = "✨BEST free script✨https://discord.gg/bnhQKTar5u"
    })
    ...
    if getfenv().setclipboard then
        DiscordWikiSection:AddButton({
            ...
            Callback = function()
                getfenv().setclipboard("https://discord.gg/bnhQKTar5u")
                Window:Dialog({
                    Title = string.format(MonthlyLabels[os.date("*t").month], "Open Aimbot"),
        ...
        DiscordWikiSection:AddParagraph({
            Title = "https://discord.gg/bnhQKTar5u",
    ...
    if UISettings.ShowWarnings then
        ...
        elseif ShowWarning then
            Window:Dialog({
                Title = "Warning",
                Content = string.format("Your Software does not support all the Features of %s 🔥Freemium🔥!", string.format(MonthlyLabels[os.date("*t").month], "joln our dc for free script at settings")),
                Buttons = {
                    {
                        Title = "Confirm"
                    }
...
GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("https://discord.gg/bnhQKTar5u") 
end) 
